...
class AmericanOffDayFinderServiceTest {
    ...
    fun invoke() {
        ...
        assertEquals(1, subject.invoke(2025, 5).size)
        assertEquals(1, subject.invoke(2025, 6).size)
        ...
        assertEquals(2, subject.invoke(2025, 11).size)
        assertEquals(1, subject.invoke(2025, 12).size)
    }
}