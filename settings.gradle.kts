...
dependencyResolutionManagement {
    versionCatalogs {
        create("libraries") {
            ...
            library("coilCompose", "io.coil-kt.coil3", "coil-compose").version("3.1.0")
            library("coilGif", "io.coil-kt.coil3", "coil-gif").version("3.1.0")
            library("coilNetwork", "io.coil-kt.coil3", "coil-network-okhttp").version("3.1.0")
