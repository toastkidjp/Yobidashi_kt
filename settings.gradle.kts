...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libraries") {
            ...
            version("compose", "1.10.6")
            version("coilCompose", "3.4.0")
            ...
            library("composeFoundation", "androidx.compose.foundation", "foundation").versionRef("compose")
            library("composeAnimation", "androidx.compose.animation", "animation").versionRef("compose")
        ...
        create("testLibraries") {
            ...
            library("robolectric", "org.robolectric", "robolectric").version("4.16.1")
