...
class DefaultColorInsertion {
    ...
    private val map = mapOf(
            jp.toastkid.lib.R.color.colorPrimaryDark to R.color.textPrimary,
        ...
        jp.toastkid.lib.R.color.cyan_bg to R.color.white,
        jp.toastkid.lib.R.color.red_200_dd to R.color.black,
        jp.toastkid.lib.R.color.yellow_200_dd to R.color.black,
            R.color.black to R.color.textPrimary,
            R.color.black to jp.toastkid.lib.R.color.deep_yellow,
        jp.toastkid.lib.R.color.indigo_200_dd to R.color.black,
            R.color.white to R.color.black,
        jp.toastkid.lib.R.color.pinky to R.color.white,
        jp.toastkid.lib.R.color.lime_bg to R.color.white,
        jp.toastkid.lib.R.color.purple_bg to R.color.white,
        jp.toastkid.lib.R.color.wa_bg to jp.toastkid.lib.R.color.wa_font,
        jp.toastkid.lib.R.color.light_blue_200_dd to R.color.white,
        jp.toastkid.lib.R.color.teal_500_dd to R.color.white,
        jp.toastkid.lib.R.color.gray_500_dd to R.color.white,
        jp.toastkid.lib.R.color.deep_orange_500_dd to R.color.white
    )
